...
/**
 * Diese Klasse stellt mit einem Kommandozeilenclient eine Alternative zu der Framevariante Client
 * bereit. Sie wurde geschaffen, um das Entwickeln von Protokollen für das Kryptologie-Praktikum zu
 * unterstützen.
 * <p>
 * Diese Einschränkung sorgt somit dafür, dass hier nur Protokolle mit einer Teilnehmerzahl von 2
...
public class CmdLineClient implements IClient {
  ...
  public void connect() {
    try {
      // create protocol
      Protocol protocol = (Protocol) Class.forName(protocolName).newInstance();
      // and communicator
      com = new Communicator(host, port, "A Server", 2, 2, this);
  ...
  public static void main(String[] args) {
    ...
    try {
      CmdLineClient client = new CmdLineClient(args[0], args[1], Integer.parseInt(args[2]));
      client.connect();
