...
/**
 * Die Klasse ClientGUI stellt die grafische Oberflaeche des Clients dar. Hier werden die Funktionen
 * des Clients fuer den Anwender zugreifbar. Servername, Spielname und Portnummer werden in der
 * grafischen Oberflaeche eingegeben und der Benutzer wird durch Druecken des Buttons "mit Server
 * verbinden" mit dem Server verbunden. Wenn er als erster Spieler am Server angemeldet ist, hat er
 * auch das Recht, das Spiel zu starten. Sonst muss er auf den Spielstart durch einen anderen
 * Mitspieler warten. Ausserdem wird jedem Button ein eigener Event-Listener zugeteilt.
 * 
...
public class ClientGUI extends Frame implements Runnable {
  ...
  private void jbInit() throws Exception {
    ...
    setSize(500, 400);
    setLocation((getToolkit().getScreenSize().width - this.getWidth()) / 2, (getToolkit().getScreenSize().height - this.getHeight()) / 2);
    ...
    this.add(serverName, new GridBagConstraints(0, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 20, 10), 10, 5));
    this.add(theGameClass, new GridBagConstraints(1, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 20, 10), 18, 5));
    this.add(portNumber, new GridBagConstraints(2, 3, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 20, 10), 4, 5));
    this.add(oldServers, new GridBagConstraints(0, 4, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 20, 10), 10, 6));
    this.add(oldGames, new GridBagConstraints(1, 4, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0, 10, 20, 10), 18, 5));
    this.add(startGame, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 10, 10));
    this.add(connectToServer, new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 10));
    this.add(clientExit, new GridBagConstraints(1, 6, 2, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(30, 0, 0, 0), 0, 10));
    this.add(output, new GridBagConstraints(0, 7, 3, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 0, 5), 1, 0));
    this.add(header, new GridBagConstraints(0, 0, 3, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(5, 5, 0, 5), 1, 0));
    this.add(ServerLabel, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 10, 0, 10), 0, 0));
    this.add(protocolLabel, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(10, 10, 0, 10), 18, 0));
  ...
  /**
   * Die Methode uebergibt die "ClientGUI" einem neuen Thread und startet die Methode "run()".
   * Vorher wird versucht, das Spiel mit dem Namen im Feld "theGameClass" zu laden. Ausserdem wird
   * die PortNummer ueberprueft, Servername und Protokollname werden mit "addHistoryItem()" der
   * jeweiligen History Datei hinzugefuegt.
   */
  void connectToServerActionPerformed(ActionEvent e) {
    ...
    try {
      ...
      if ((Integer.parseInt(portNumber.getText()) < 1024) || (Integer.parseInt(portNumber.getText()) > 9999)) {
        allOk = false;
  ...
  void clientExitActionPerformed(ActionEvent e) {
    popUpWindow dialog = new popUpWindow(this, "Wollen Sie den Client wirklich beenden?");
  ...
  /**
   * Ruft beim Druecken einer Taste im Textfeld "serverName" die Methode "serverNameChanged()" auf.
   * 
   * @param KeyEvent
   *          e KeyEvent
   */
  ...
  /**
   * Setzt den Ausgewaehlten Namen in das Textfeld und ruft die Methode "serverNameChanged()".
   * 
   * @param ItemEvent
   *          e ItemEvent
   */
  ...
  /**
   * Aktiviert den Button "ConnectToServer" falls Port-Nummer, Servername und Protokollname
   * eingegeben sind.
   */
  private void serverNameChanged() {
    if (client.getCommunicator() != null) {
      popUpWindow dialog = new popUpWindow(this, "Wollen Sie sich wirklich vom Server abmelden ?");
  ...
  /**
   * Ruft beim Druecken einer Taste im Textfeld "theGameClass" die Methode "gameNameChanged()" auf.
   * 
   * @param KeyEvent
   *          e KeyEvent
   */
  ...
  /**
   * Setzt den Ausgewaehlten Namen in das Textfeld und ruft "gameNameChanged()" auf.
   * 
   * @param ItemEvent
   *          e ItemEvent
   */
  ...
  /**
   * Versucht eine Datei mit dem Namen "historyFile" zu lesen und fuegt die Namen aus dieser Datei
   * dem Choice Objekt hinzu.
   * 
   * @param choiceHistory
   *          Choice-Objekt, dem die History-Eintraege zugewiesen werden sollen.
   * @param historyFile
   *          Name der Datei die die History-Eintraege speichert.
   */
  void initHistory(Choice choiceHistory, String historyFile) {
    ...
    // Wenn noch keine History-Datei gefunden wurde, neue leere Datei anlegen.
      ...
      try {
        BufferedWriter fw = new BufferedWriter(new FileWriter(historyFile));
  ...
  /**
   * Liest eine Datei mit dem Namen "historyFile" zu lesen, fuegt den Namen "newItem" des neuen
   * History-Eintrags der Datei zu, sofern noch nicht vorhanden und fuegt ihn ausserdem dem Choice
   * Objekt hinzu.
   * 
   * @param choiceHistory
   ...
   *          Name der Datei die die History-Eintraege speichert.
   * @param newItem
   *          Name des Items das hinzugefuegt werden soll.
   */
  ...
  void addHistoryItem(Choice choiceHistory, String historyFile, String newItem) {
    ...
    if (!alreadyInHistory) {
      try {
        BufferedWriter fw = new BufferedWriter(new FileWriter(historyFile, true));
        fw.write(newItem + "\n");
        fw.close();
  ...
  /**
   * Die Methode schreibt den im String "text" angegebenen Text auf das Label output. <br>
   * Wenn der Client bereits am Server angemeldet ist wird die Spielernummer vor dem Text
   * mitausgegeben. Wenn ein leerer String uebergeben wird, wird nur die Spielernummer erneuert.
   * 
   * @param text
  ...
  void printOutput(String text) {
    ...
    if (client.getCommunicator() != null) {
      preText = "Spieler " + (client.getCommunicator().myNumber() + 1) + "(Anzahl der Spieler :" + client.getCommunicator().playerNumber() + ") : ";
    } else
      preText = "";
