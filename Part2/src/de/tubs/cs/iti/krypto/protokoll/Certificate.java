...
public class Certificate {
  ...
  /**
   * Instantiates a new Certificate object with the given parameters. This constructor is called by
   * <cite>TrustedAuthority</cite> to generate certificates.
   * 
   * @param ID
   *          the ID-String of the certificate
   * @param data
   *          the data contained in the certificate (e.g. a key of a public key kryptosystem)
   * @param signature
   *          the signature on ID and data that is computed by the trusted authority
   */
  ...
  /**
   * A ccess method for the ID-String of the certificate.
   * 
